...
class NetgearC7000v2Parser(ModemParser):
    ...
    def can_parse(cls, soup: BeautifulSoup, url: str, html: str) -> bool:
        """Detect if this is a Netgear C7000v2.

        Detection strategy:
        - Check for "NETGEAR Gateway C7000v2" in title
        - Check for meta description containing "C7000v2"
        - Check for "C7000v2" in page content
