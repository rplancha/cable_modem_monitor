...
- **Protocol**: ![HTML](https://img.shields.io/badge/-HTML-E34C26?style=flat-square) = web scraping | ![LuCI](https://img.shields.io/badge/-LuCI-00B5E2?style=flat-square) = [OpenWrt](https://openwrt.org/docs/guide-user/luci/start) web interface | **[HNAP](https://en.wikipedia.org/wiki/Home_Network_Administration_Protocol)** = [SOAP](https://www.w3.org/TR/soap/)-based, requires auth
